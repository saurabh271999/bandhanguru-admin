export const UNITS = [
  { label: "Numbers/Pieces", value: "Number/Pieces" },
  ...
  { label: "Newtons", value: "Newtons" },
  { label: "Joules", value: "Joules" },
  { label: "Watts", value: "Watts" },
  { label: "Volts", value: "Volts" },
  { label: "Amperes", value: "Amperes" },
...
export const CONSTRUCTION_OPTIONS = [
  ...
  { label: "Exterior Design", value: "Exterior Design" },
  { label: "Landscaping", value: "Landscaping" },
  { label: "Structural Engineering", value: "Structural Engineering" },
  { label: "Civil Engineering", value: "Civil Engineering" },
  { label: "Concrete Work", value: "Concrete Work" },
  { label: "Steel Fabrication", value: "Steel Fabrication" },
  { label: "Glass & Glazing", value: "Glass & Glazing" },
  ...
  { label: "Tile Installation", value: "Tile Installation" },
  { label: "Drywall Installation", value: "Drywall Installation" },
  { label: "Cabinet Installation", value: "Cabinet Installation" },
  { label: "Countertops", value: "Countertops" },
  { label: "Gutter Installation", value: "Gutter Installation" },
  { label: "Fire Protection Systems", value: "Fire Protection Systems" },
  ...
  { label: "Pool Construction", value: "Pool Construction" },
  { label: "Paving & Driveways", value: "Paving & Driveways" },
  { label: "Scaffolding", value: "Scaffolding" },
  { label: "Site Surveying", value: "Site Surveying" },
  { label: "Acoustic Treatment", value: "Acoustic Treatment" },
  ...
  { label: "Steel Reinforcement", value: "Steel Reinforcement" },
  {
    label: "Prefabrication & Modular Construction",
    value: "Prefabrication & Modular Construction",
  },
  { label: "Site Preparation", value: "Site Preparation" },
  { label: "Basement Waterproofing", value: "Basement Waterproofing" },
  { label: "Energy Audits & Efficiency", value: "Energy Audits & Efficiency" },
...
export const getStatesAndCites = (state) => {
  const statesCities = {
  ...
  const states = Object.keys(statesCities)
    ...
    .map((state) => ({ name: state, _id: state }));
